...
class Game:
    ...
    def update(self):
        ...
        # load the creation of the tournament
            ...
            # app the background
            self.c_main.v_basic.manage_view(
                self.c_main.m_game.background, (0, 0))
    ...
    def show_match(self):
        ...
        self.c_main.v_basic.manage_view(
            self.c_main.m_game.area_rect_win_1, self.c_main.m_game.area_win_1)
        self.c_main.v_basic.manage_view(
            self.c_main.m_game.area_rect_win_2, self.c_main.m_game.area_win_2)
        ...
        self.c_main.v_basic.manage_view(
            self.c_main.m_game.area_rect_win_3, self.c_main.m_game.area_win_3)
        self.c_main.v_basic.manage_view(
            self.c_main.m_game.area_rect_win_4, self.c_main.m_game.area_win_4)
        ...
        self.c_main.v_basic.manage_view(
            self.c_main.m_game.area_rect_win_5, self.c_main.m_game.area_win_5)
        self.c_main.v_basic.manage_view(
            self.c_main.m_game.area_rect_win_6, self.c_main.m_game.area_win_6)
        ...
        self.c_main.v_basic.manage_view(
            self.c_main.m_game.area_rect_win_7, self.c_main.m_game.area_win_7)
        self.c_main.v_basic.manage_view(
            self.c_main.m_game.area_rect_win_8, self.c_main.m_game.area_win_8)

        # button validate and settings
        self.c_main.v_basic.manage_view(
            self.c_main.m_game.update_score, self.c_main.m_game.update_score_rect)
        tmp_check = True
    ...
    def show_settings(self):
        ...
        for player in self.c_main.m_round.players:
            player.rect = self.c_main.v_basic.set_an_image_rec(
                player.img, x, y)
    ...
    def show_prev_matchs(self):
        """method to show the prev match
        """
        if self.c_main.m_game.match_load:
            load = self.c_main.m_sql.get_players_score(
                self.c_main.m_game.match_load)
            x = 50
            y = 50
            for data in load:
                self.c_main.v_basic.print_sentence(
                ...
                y += 50
            self.c_main.v_basic.manage_view(
                self.c_main.m_game.prev, self.c_main.m_game.prev_rect)
