...
class Game:
    ...
    def update(self):
        ...
        # load the tournament
            ...
            if self.c_main.m_game.round.settings:
                self.show_settings()
    ...
    def show_match(self):
        ...
        self.c_main.v_basic.print_sentence(
            f"Round match list n°{self.c_main.m_game.round.nb_turn + 1}", self.c_main.m_game.font, (400, 50))

        # match 1
        self.c_main.v_basic.print_sentence(
            f"{self.c_main.m_game.round.match[0][0].last_name[0]}.{self.c_main.m_game.round.match[0][0].name[:5]}", self.c_main.m_game.font, (50, 190))
        self.c_main.v_basic.print_sentence(
            f"{self.c_main.m_game.round.match[0][1].last_name[0]}.{self.c_main.m_game.round.match[0][1].name[:5]}", self.c_main.m_game.font, (450, 190))
        ...
        # match 2
        self.c_main.v_basic.print_sentence(
            f"{self.c_main.m_game.round.match[1][0].last_name[0]}.{self.c_main.m_game.round.match[1][0].name[:5]}", self.c_main.m_game.font, (50, 490))
        self.c_main.v_basic.print_sentence(
            f"{self.c_main.m_game.round.match[1][1].last_name[0]}.{self.c_main.m_game.round.match[1][1].name[:5]}", self.c_main.m_game.font, (450, 490))
        ...
        # match 3
        self.c_main.v_basic.print_sentence(
            f"{self.c_main.m_game.round.match[2][0].last_name[0]}.{self.c_main.m_game.round.match[2][0].name[:5]}", self.c_main.m_game.font, (650, 190))
        self.c_main.v_basic.print_sentence(
            f"{self.c_main.m_game.round.match[2][1].last_name[0]}.{self.c_main.m_game.round.match[2][1].name[:5]}", self.c_main.m_game.font, (1050, 190))
        ...
        # match 4
        self.c_main.v_basic.print_sentence(
            f"{self.c_main.m_game.round.match[3][0].last_name[0]}.{self.c_main.m_game.round.match[3][0].name[:5]}", self.c_main.m_game.font, (650, 490))
        self.c_main.v_basic.print_sentence(
            f"{self.c_main.m_game.round.match[3][1].last_name[0]}.{self.c_main.m_game.round.match[3][1].name[:5]}", self.c_main.m_game.font, (1050, 490))
    ...
    def show_result(self):
        ...
        """
        self.c_main.m_game.round.sort_by_rank()
        x = 40
        y = 40
        for index in range(1, 9):
            self.c_main.v_basic.print_sentence(
                f"Place {index}: {self.c_main.m_game.round.players[index-1].name} {self.c_main.m_game.round.players[index-1].last_name}, score = {self.c_main.m_game.round.players[index-1].score}", self.c_main.m_game.font, (x, y))
            y += 70
